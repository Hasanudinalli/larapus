...
<table class="table">
 <tr>
  ...
  @foreach($author as $data)
      ...
      <a href="{{route('author.show',$data->id)}}" class="btn btn-outline-warnig">Show</a>
      <button type="submit" class="btn btn-outline-danger" onclik="return confirm('Apakah anda yakin menghapus')">Delete</button>
      </form>
      </td>
      </tr>
  @endforeach
